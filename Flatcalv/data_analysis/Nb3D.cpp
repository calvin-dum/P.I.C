...
//Pour écriture fichier
  int numero_du_fichier= 10;
  char* modele_nom_fichier = "Nb%04d.txt";
...
/*___on initialise les valeurs de paramètres___*/
	...
	double Fr=0.00066; //ecart type de la force random
...
/*___On va ecrire dans le fichier___*/
			write_in(numero_du_fichier, modele_nom_fichier,0.4*Nb);//le numero de l'experience
